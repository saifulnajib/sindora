...
<template>
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4"> <InputLabel for="email" value="Email" />
            ...
            <div class="mt-4"> <InputLabel for="password" value="Password" />
            ...
            <div class="mt-4"> <InputLabel for="password_confirmation"
                ...
                <InputError
                    class="mt-2" :message="form.errors.password_confirmation"
                />
            </div>
